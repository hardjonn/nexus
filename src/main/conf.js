...
const defaultConfig = {
  steam: {
    ...
    binding_icons_path: '/home/deck/.local/share/Steam/tenfoot/resource/images/library/controller/binding_icons',
  },
  remote_lib: {
    host: 'nexus.host',
    user: 'nexus',
  ...
  properties: {
    steam: {
      ...
      properties: {
        ...
        binding_icons_path: {
          type: 'string',
          default: '/home/deck/.local/share/Steam/tenfoot/resource/images/library/controller/binding_icons',
        },
      },
    },
    remote_lib: {
